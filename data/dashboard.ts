  ...
  export const dashboard: DashboardInterface = {
    ...
    "Threads": {
      ...
      "1": {
        ...
        "Context": "Tm1py",
        "State": "Idle",
        "Function": "POST /api/v1/Processes(`Calc_Conso_Luxembourg`)/tm1.Execute tm1 Idriss Idrs",
        "ObjectType": "",
        "ObjectName": "",
        "RLocks": 0,
        "IXLocks": 0,
    ...
    "Logs": {
      ...
      "3": {
        ...
        "Logger": "TM1.Process",
        "Message": "Processus `Calc_Conso_Belgique`:  exécution terminée normalement, temps écoulé 10.01 secondes"
      },
      "4": {
        "ID": 2829892952,
        "ThreadID": 43992,
        ...
        "Logger": "TM1.Process",
        "Message": "Processus `Calc_Conso_Belgique`:  exécution terminée normalement, temps écoulé 10.02 secondes"
      },
      "5": {
        "ID": 2829892953,
        "ThreadID": 20632,
      ...
      "21": {
        ...
        "Logger": "TM1.Process",
        "Message": "Processus `Calc_Conso_Luxembourg`:  exécution terminée normalement, temps écoulé 5.01 secondes"
      },
      "22": {
        "ID": 2829892970,
        "ThreadID": 66716,
        ...
        "Logger": "TM1.Process",
        "Message": "Processus `Calc_Conso_Belgique`:  exécution terminée normalement, temps écoulé 10.00 secondes"
      },
      "23": {
        "ID": 2829892971,
        "ThreadID": 24276,
      ...
      "24": {
        ...
        "Logger": "TM1.Process",
        "Message": "Processus `Calc_Conso_Luxembourg`:  exécution terminée normalement, temps écoulé 5.00 secondes"
      },
      "25": {
        "ID": 2829892973,
        "ThreadID": 25448,
