...
<Table className="m-4 h-[50vh] w-[58vw]">
  ...
  <TableBody className="overflow-hidden">
    <TableRow className="h-[10px]">
      ...
      <TableCell className="flex h-full w-auto  items-center justify-between  px-5 text-white">
        <Button className=" w-[100px] rounded-none bg-[#0043ce]">Show</Button>
        <Button className=" w-[100px] rounded-none bg-[#24A148]">Deliver</Button>
        <Button className="w-[100px] rounded-none bg-[#DA1E28]">Delete</Button>
      </TableCell>
    </TableRow>
    <TableRow className="h-[10px]">
